(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["general-general-module"], {
        ...
        _createClass(GeoService, [{
          ...
          value: function fetchCitiesByState(state) {
            ...
            this.http.get("".concat(this.baseUrl, "/general/cities/").concat(state)).subscribe(function (data) {
              _this5.currentCities.next(Object.assign(_this5.currentCities.getValue(), _defineProperty({}, state, data)));
            });
          }
        }]);
    ...
    function Upv(module, __webpack_exports__, __webpack_require__) {
      ...
      var _business_services_user_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var src_app_core_validators_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      ...
      var ChangePasswordComponent = /*#__PURE__*/function () {
        function ChangePasswordComponent(userService, fb, notificationService, router, validatorsService) {
        ...
        _createClass(ChangePasswordComponent, [{
          key: "toggleShowPass",
          value: function toggleShowPass(event) {
          ...
          value: function onSubmit() {
            ...
            if (this.passForm.invalid) {
              return Object.values(this.passForm.controls).forEach(function (control) {
              ...
              this.userService.changePassword(body).subscribe(function (res) {
                ...
                _this6.notificationService.success("Password updated");
                ...
                if ((_b = (_a = err.error) === null || _a === void 0 ? void 0 : _a.message) === null || _b === void 0 ? void 0 : _b.includes("Invalid current password")) {
                  _this6.notificationService.error("Invalid current password");
                } else {
      ...
      ChangePasswordComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function ChangePasswordComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function ChangePasswordComponent_Template_input_change_28_listener($event) {
              return ctx.toggleShowPass($event);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ChangePasswordComponent_Template_button_click_33_listener() {
              return ctx.onCancel();
            });
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ChangePasswordComponent, [{
          ...
          return [{
            type: _business_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"]
          }, {
            ...
            type: src_app_core_validators_service__WEBPACK_IMPORTED_MODULE_5__["ValidatorsService"]
          }];
        }, null);
      })();
      /***/
    ...
    /***/
    function hxwH(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "generalRoutes", function () {
      ...
      var _user_profile_user_profile_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    /***/
    function sM6W(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _core_config_constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../../core/config/constants */
      "AJa1");
      /* harmony import */


      var _business_services_user_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../../business/services/user.service */
      "RaVz");
      /* harmony import */
      ...
      var src_app_authentication_authentication_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      ...
      function UserProfileComponent_div_9_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function UserProfileComponent_div_15_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function UserProfileComponent_div_20_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 41);
      ...
      function UserProfileComponent_option_43_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function UserProfileComponent_option_50_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "option", 42);
      ...
      var UserProfileComponent = /*#__PURE__*/function () {
        function UserProfileComponent(userService, fb, geoService, notificationService, router, authService) {
          var _this7 = this;
          ...
          this.buildForms();
          var sub = this.userService.getUserAuth().subscribe(function (data) {
            _this7.user = data;
          ...
          value: function onSubmit() {
            ...
            if (this.userForm.invalid) {
              ...
              var _a = this.userForm.value,
                  ...
                  canModifyCustomers = _a.canModifyCustomers,
                  canEmailInvoices = _a.canEmailInvoices,
                  isDriver = _a.isDriver,
                  isAdmin = _a.isAdmin,
                  receiveEmail = _a.receiveEmail,
                  commission = _a.commission,
                  rest = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__rest"])(_a, ["isManager", "canModifyCustomers", "canEmailInvoices", "isDriver", "isAdmin", "receiveEmail", "commission"]);
              var body = rest;
              ...
              if (this.isAdmin) {
                ...
                body.options = {
                  ...
                  canEmailInvoices: canEmailInvoices,
                  isDriver: isDriver,
                  isAdmin: isAdmin,
              ...
              this.userService.updateUser(body, this.user.id, this.isAdmin).subscribe(function (res) {
                _this9.isLoading = false;

                _this9.notificationService.success("Profile updated");
              }, function (err) {
                _this9.notificationService.error();
      ...
      UserProfileComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        template: function UserProfileComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngSubmit", function UserProfileComponent_Template_form_ngSubmit_10_listener() {
              return ctx.onSubmit();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("change", function UserProfileComponent_Template_select_change_40_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function UserProfileComponent_Template_button_click_64_listener() {
              return ctx.onCancel();
            });
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](UserProfileComponent, [{
          ...
          return [{
            type: _business_services_user_service__WEBPACK_IMPORTED_MODULE_4__["UserService"]
          }, {
            ...
            type: src_app_authentication_authentication_service__WEBPACK_IMPORTED_MODULE_8__["AuthenticationService"]
          }];
        }, null);
      })();
      /***/
    ...
    /***/
    function ugPw(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var HomeComponent = /*#__PURE__*/function () {
        function HomeComponent(companyService) {
          ...
          this.subscriptions = [];
          this.time = "week";
          var sub = this.companyService.dashboardInfo.subscribe(function (data) {
            _this10.info = data;
          });
          this.subscriptions.push(sub);
        }
      ...
      HomeComponent.ɵfac = function HomeComponent_Factory(t) {
        return new (t || HomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_business_services_company_service__WEBPACK_IMPORTED_MODULE_1__["CompanyService"]));
      };
      ...
      HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 104,
        vars: 24,
        consts: [[1, "px-2", "px-md-5", "pt-3"], [1, "d-flex", "justify-content-between", "col-12", "align-items-end", "mb-4"], [1, "text-dark", "content-title"], [1, "content-sub-title"], [1, "d-flex"], [1, "btn", "font-weight-bold", "time-btn", "rounded-sm", 3, "click"], [1, "row", "text-dark"], [1, "col-12", "p-3", "rounded-lg"], [1, "justify-content-between", "items-grid"], [1, "item-card-big", "d-flex", "justify-content-between", "align-items-center", "px-3", "py-4", "rounded-lg", "font-weight-bold", "shadow-sm"], [1, "d-flex", "align-items-center"], [1, "text-3xl"], [1, "ml-3", "text-xl"], [1, "text-2xl"], [1, "item-card", "d-flex", "justify-content-between", "align-items-center", "p-3", "rounded-lg", "font-weight-bold", "shadow-sm"], [1, "h3"], [1, "ml-3"]],
