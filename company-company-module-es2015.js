...
class ProfileComponent {
    ...
    buildForm() {
        this.profileForm = this.fb.group({
            name: [{ value: "", disabled: !this.isEditionAble }, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
            contact_name: [{ value: "", disabled: !this.isEditionAble }, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
            address_line_1: [{ value: "", disabled: !this.isEditionAble }, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
            address_line_2: [{ value: "", disabled: !this.isEditionAble }, []],
            zip: [{ value: "", disabled: !this.isEditionAble }, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
            office_phone: [{ value: "", disabled: !this.isEditionAble }, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
            fax: [{ value: "", disabled: !this.isEditionAble }, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
            city: [{ value: "", disabled: !this.isEditionAble }, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
            starting_invoice_number: [{ value: "", disabled: true }],
        });
    }
    loadFormData() {
        var _a;
